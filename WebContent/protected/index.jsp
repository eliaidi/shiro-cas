...
<body>
	<div class="container">
		<ul class="nav nav-tabs">
			<li><a href="${pageContext.request.contextPath }/index.jsp">Call the /index.jsp page</a></li>
			<li class="active"><a href="${pageContext.request.contextPath }/protected/index.jsp">You are on the /protected/index.jsp page</a></li>
